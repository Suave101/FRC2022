...
class AbsoluteSensorRange():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    Signed_PlusMinus180: ctre._ctre.AbsoluteSensorRange # value = <AbsoluteSensorRange.Signed_PlusMinus180: 1>
    Unsigned_0_to_360: ctre._ctre.AbsoluteSensorRange # value = <AbsoluteSensorRange.Unsigned_0_to_360: 0>
...
class CANCoderStatusFrame():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    SensorData: ctre._ctre.CANCoderStatusFrame # value = <CANCoderStatusFrame.SensorData: 267264>
    VbatAndFaults: ctre._ctre.CANCoderStatusFrame # value = <CANCoderStatusFrame.VbatAndFaults: 267328>
...
class MagnetFieldStrength():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    Adequate_OrangeLED: ctre._ctre.MagnetFieldStrength # value = <MagnetFieldStrength.Adequate_OrangeLED: 2>
    BadRange_RedLED: ctre._ctre.MagnetFieldStrength # value = <MagnetFieldStrength.BadRange_RedLED: 1>
    Good_GreenLED: ctre._ctre.MagnetFieldStrength # value = <MagnetFieldStrength.Good_GreenLED: 3>
    Invalid_Unknown: ctre._ctre.MagnetFieldStrength # value = <MagnetFieldStrength.Invalid_Unknown: 0>
...
class PigeonIMU(CANBusAddressable):
    ...
    class CalibrationMode():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        Accelerometer: ctre._ctre.PigeonIMU.CalibrationMode # value = <CalibrationMode.Accelerometer: 5>
        BootTareGyroAccel: ctre._ctre.PigeonIMU.CalibrationMode # value = <CalibrationMode.BootTareGyroAccel: 0>
        Magnetometer12Pt: ctre._ctre.PigeonIMU.CalibrationMode # value = <CalibrationMode.Magnetometer12Pt: 2>
        Magnetometer360: ctre._ctre.PigeonIMU.CalibrationMode # value = <CalibrationMode.Magnetometer360: 3>
        Temperature: ctre._ctre.PigeonIMU.CalibrationMode # value = <CalibrationMode.Temperature: 1>
    ...
    class PigeonState():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        Initializing: ctre._ctre.PigeonIMU.PigeonState # value = <PigeonState.Initializing: 1>
        NoComm: ctre._ctre.PigeonIMU.PigeonState # value = <PigeonState.NoComm: 0>
        Ready: ctre._ctre.PigeonIMU.PigeonState # value = <PigeonState.Ready: 2>
        UserCalibration: ctre._ctre.PigeonIMU.PigeonState # value = <PigeonState.UserCalibration: 3>
...
class PigeonIMU_ControlFrame():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    PigeonIMU_CondStatus_Control_1: ctre._ctre.PigeonIMU_ControlFrame # value = <PigeonIMU_ControlFrame.PigeonIMU_CondStatus_Control_1: 272384>
...
class PigeonIMU_StatusFrame():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    PigeonIMU_BiasedStatus_2_Gyro: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_BiasedStatus_2_Gyro: 269376>
    PigeonIMU_BiasedStatus_4_Mag: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_RawStatus_4_Mag: 269504>
    PigeonIMU_BiasedStatus_6_Accel: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_BiasedStatus_6_Accel: 269632>
    PigeonIMU_CondStatus_10_SixDeg_Quat: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_10_SixDeg_Quat: 270912>
    PigeonIMU_CondStatus_11_GyroAccum: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_11_GyroAccum: 270976>
    PigeonIMU_CondStatus_1_General: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_1_General: 270336>
    PigeonIMU_CondStatus_2_GeneralCompass: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_2_GeneralCompass: 270400>
    PigeonIMU_CondStatus_3_GeneralAccel: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_3_GeneralAccel: 270464>
    PigeonIMU_CondStatus_6_SensorFusion: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_6_SensorFusion: 270656>
    PigeonIMU_CondStatus_9_SixDeg_YPR: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_CondStatus_9_SixDeg_YPR: 270848>
    PigeonIMU_RawStatus_4_Mag: ctre._ctre.PigeonIMU_StatusFrame # value = <PigeonIMU_StatusFrame.PigeonIMU_RawStatus_4_Mag: 269504>
...
class SensorInitializationStrategy():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BootToAbsolutePosition: ctre._ctre.SensorInitializationStrategy # value = <SensorInitializationStrategy.BootToAbsolutePosition: 1>
    BootToZero: ctre._ctre.SensorInitializationStrategy # value = <SensorInitializationStrategy.BootToZero: 0>
...
class SensorTimeBase():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    Per100Ms_Legacy: ctre._ctre.SensorTimeBase # value = <SensorTimeBase.Per100Ms_Legacy: 0>
    PerMinute: ctre._ctre.SensorTimeBase # value = <SensorTimeBase.PerMinute: 2>
    PerSecond: ctre._ctre.SensorTimeBase # value = <SensorTimeBase.PerSecond: 1>
...
class SensorVelocityMeasPeriod():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    Period_100Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_100Ms: 100>
    Period_10Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_10Ms: 10>
    Period_1Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_1Ms: 1>
    Period_20Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_20Ms: 20>
    Period_25Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_25Ms: 25>
    Period_2Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_2Ms: 2>
    Period_50Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_50Ms: 50>
    Period_5Ms: ctre._ctre.SensorVelocityMeasPeriod # value = <SensorVelocityMeasPeriod.Period_5Ms: 5>
...
class StatusFrame():
    ...
    Status_15_FirmareApiStatus_: ctre._ctre.StatusFrame # value = <StatusFrame.Status_15_FirmareApiStatus_: 6016>
...
class StatusFrameEnhanced():
    ...
    Status_15_FirmareApiStatus: ctre._ctre.StatusFrameEnhanced # value = <StatusFrameEnhanced.Status_15_FirmareApiStatus: 6016>
